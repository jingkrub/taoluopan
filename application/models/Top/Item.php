<?php
class Ecmpc_Model_Top_Item
{
    private $c;
    private $item;
    
    public function __construct() {
        $this->c = Ecmpc_Model_Top_Endpoint::getEndpoint();
//         $this->item = new Ecmpc_Model_DbTable_Item();
    }
    ...
    {        
        ...
        $req->setFields(join(",", Ecmpc_Model_Item::getKeys()));
