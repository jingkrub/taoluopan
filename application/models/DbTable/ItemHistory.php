...
class Navo_Model_DbTable_ItemHistory extends Zend_Db_Table_Abstract
{
    /**
     * The default table name 
     */
    protected $_name = 'item_history';
...
//     }
    ...
    public function sqlGetLastItemUpdate($itemId)
    {
        $where = $this->select()->where('item_id = ?' , $itemId)
        				->order('update_timestamp DESC')->limit(1);
